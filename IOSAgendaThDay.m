...
@interface IOSAgendaThDay ()

@end

@implementation IOSAgendaThDay{
    int i ;
}
...
//    }
//    [_result addObjectsFromArray:[[data[2] agendaSessions] allObjects]];
//    
//    if (_result != nil) {
...
//    [c getSessions];
        ...
        _result = [NSMutableArray new];
    if (agendas.count>0) {
        [_result addObjectsFromArray:[[agendas[2] agendaSessions] allObjects]];
...
{
    static NSString *CellIdentifier = @"agendaThCell";
