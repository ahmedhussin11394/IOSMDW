...
- (UIBarButtonItem *)barButtonItemForMenu:(Menu)menu
{
	...
	UIBarButtonItem *customButton = (menu == MenuLeft) ? self.rightBarButtonItem: self.rightBarButtonItem;
...
- (void)prepareMenuForReveal:(Menu)menu
{
    ...
    UIViewController *menuViewController = (menu == MenuLeft) ? self.rightMenu : self.rightMenu;
	UIViewController *removingMenuViewController = (menu == MenuLeft) ? self.rightMenu : self.rightMenu;
